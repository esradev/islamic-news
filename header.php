    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex h-16 justify-between">
                    ...
                    <div class="hidden md:items-center md:mr-4 md:flex md:gap-2">
